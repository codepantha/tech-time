...
const Header = () => (
  <motion.div className="h-full max-w-full bg-primary px-4 md:px-20 pb-24">
    <Navbar />
    <motion.header className="grid md:grid-cols-2 mt-8">
      <motion.div className="text-center md:text-left md:mt-[100px]">
        ...
        <div className="flex gap-4 mt-8 w-full justify-center md:justify-start">
          <button
            type="button"
            className="py-4 px-4 md:px-8 border-2 border-white text-white text-[10px] md:text-[16px] flex items-center gap-3 hover:bg-neutral hover:text-white"
          >
            Get Started Now
          ...
          <button
            type="button"
            className="py-4 px-8 bg-white text-primary text-[10px] md:text-[16px] hover:bg-neutral hover:text-white hover:border-2"
          >
            Enroll Now
          </button>
        </div>
      ...
      <motion.div className="header-right relative">
        <div className="bg bg-no-repeat bg-contain bg-center">
          <img src={images.hero} alt="" />
        </div>
        <img src={images.idea} width="180" className="absolute -top-4 -left-14" alt="bulb" />
        <img src={images.vscode} width="70" height="70" alt="bulb" className="absolute top-5 right-3" />
        <img src={images.figma} width="70" height="70" alt="figma" className="absolute top-[50%] left-0" />
        <img src={images.wordpress} width="70" height="70" alt="wordpress" className="absolute bottom-20 right-0" />
      </motion.div>
    </motion.header>
  </motion.div>
);
